...
// 1) calculate the length of the arrays
...
for ( let row of finances){
 ...
 // found on https://stackoverflow.com/a/60869817
 let average = total/(size - 1);
 console.log ("Average Change: " + Number(average.toFixed(2)));
